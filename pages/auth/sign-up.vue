<template>
    <div class="min-h-screen rounded-lg flex items-center justify-center bg-gradient-to-br from-black to-[#0e1222]">
        <div
            ...
            <div class="col-span-full lg:col-span-1 bg-gray-700 rounded-l-lg text-center lg:rounded-r-lg hidden lg:flex">
                <div class="relative w-full bg-cover bg-center rounded-l-lg bg-no-repeat bg-[url(/img/sign-up.jpg)] overflow-hidden">
                    ...
                    <div class="w-full flex-1 mt-6">
                        <div class="flex justify-center items-center">
                            <div class="flex gap-3">
                                <div>
                                    <UButton label="Sign Up with Google" color="black" size="xl"
                                        icon="logos:google-icon" />
                                </div>

                                <div>
                                    <UButton label="Sign Up with Facebook" color="black" size="xl"
                                        icon="logos:facebook" />
                                </div>
                        ...
                        <div class="mx-auto flex flex-col gap-3">
                            ...
                            <UButton label="Sign Up" color="indigo" size="xl" icon="ic:baseline-person-add-alt-1"
                                block />
