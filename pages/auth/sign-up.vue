<template>
    <div class="flex h-screen">
        <div class="hidden lg:flex items-center justify-center flex-1 bg-gray-700 text-black">
        ...
        <div class="w-full bg-gray-800 lg:w-1/2 flex items-center justify-center">
            <div class="max-w-md w-full p-6">
                <h1 class="mb-6 text-center text-2xl xl:text-3xl font-extrabold text-white">Sign Up for Evermuzic</h1>
                ...
                <div class="mt-4 flex flex-col lg:flex-row items-center justify-between">
                    <div class="w-full lg:w-1/2 mb-2 lg:mb-0">
                        <button
                            class="w-full max-w-xs font-bold text-sm shadow-sm rounded-lg py-2 bg-gray-700 text-white flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline">
                    ...
                    <div class="w-full lg:w-1/2 ml-0 lg:ml-2">
                        <button
                            ...
                            <div class="bg-white p-1 rounded-full">
                                <svg class="w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" id="facebook">
                ...
                <div class="space-y-4">
                    <UInput class="mb-3" color="sky" type="name" size="xl" placeholder="Name" />
                    <UInput class="mb-3" color="sky" type="username" size="xl" placeholder="Username" />
                    <UInput class="mb-3" color="sky" type="email" size="xl" placeholder="Email" />
                    <UInput color="sky" type="password" size="xl" placeholder="Password" />
                    <button
                        class="mt-4 tracking-wide font-semibold bg-indigo-500 text-white w-full py-3 rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
                ...
                <div class="flex mt-2 justify-center">
                    <p class="mr-2 text-white">Already have an account?</p>
                    <nuxt-link to="/auth/sign-in" class="text-blue-500 hover:underline">Login here</nuxt-link>
                </div>
            </div>
        </div>
    </div>
