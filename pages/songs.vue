            ...
            <div class="p-5">
                <div class="grid gap-4 grid-cols-2 lg:grid-cols-6">
                    ...
                    <div class="col-span-2 lg:col-span-4 space-y-4">
                        <p class="text-white text-xl font-bold">Main</p>
                        <div
                            ...
                            <div class="-mt-2">
                                <p class="text-white text-lg font-semibold">Billie Eilish</p>
                                <p class="text-gray-300 text-2xl line-clamp-1">What was I made for?</p>
                                <UButton label="Listen Now" color="black"
                                    icon="material-symbols:play-arrow-rounded" class="rounded-full mt-20" />
                            </div>
                            <div class="-mt-16">
                                ...
                                <div class="flex space-x-2">
                                    <div v-for="item in playlist" :key="item.title"
                                        ...
                                        <div
                                            ...
                                            <p class="text-sm text-gray-300 text-right">{{ item.tracks }} tracks</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 p-4">
                                <div v-for="item in alsolike" :key="item.title"
