            ...
            <div class="p-5">
                <div class="grid gap-4 grid-cols-2 lg:grid-cols-4">
                    ...
                    <div class="col-span-2 lg:col-span-3 space-y-4">
                        ...
                        <div class="w-full shadow-lg rounded-lg shadow-slate-950" v-if="!featuredPlaylists.length">
                        ...
                        <div class="w-full rounded-lg bg-[#05060e88] backdrop-blur-lg shadow-lg shadow-slate-950">
